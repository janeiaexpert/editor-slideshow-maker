...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Ativador Automático de Produtos Virais",
    description: "Transforme sua ideia em um produto digital completo, pronto para vender — em minutos.",
    url: "https://ativador-produto-v2.vercel.app",
    siteName: "Ativador Produto Digital",
    locale: "pt_BR",
    type: "website",
    images: [
      {
        url: "https://ativador-produto-v2.vercel.app/og-image.png",
        width: 1200,
        height: 630,
        alt: "Ativador Automático de Produtos Virais",
        type: "image/png",
      },
    ],
  },
  twitter: {
    ...
    title: "Ativador Automático de Produtos Virais",
    description: "Transforme sua ideia em um produto digital completo, pronto para vender — em minutos.",
    images: ["https://ativador-produto-v2.vercel.app/og-image.png"],
  },
}
