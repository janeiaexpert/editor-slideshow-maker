...
const FALLBACKS: Record<string, (idea: string, lucro?: number, produto?: ProdutoInfo) => Record<string, string>> = {
  ...
  // === ARTEFATOS ===
  logo: () => ({
    "Logo Principal SVG": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 180" style="max-width:100%;width:100%;height:auto;display:block;aspect-ratio:6/1"><defs><linearGradient id="lg" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#8B5E3C"/><stop offset="100%" stop-color="#6B4226"/></linearGradient></defs><rect width="1080" height="180" fill="#F5EFE8" rx="12"/><rect x="20" y="20" width="140" height="140" rx="24" fill="url(#lg)"/><text x="90" y="100" font-family="Georgia,serif" font-size="56" font-weight="bold" fill="#FFFFFF" text-anchor="middle">V</text><rect x="175" y="40" width="4" height="40" rx="2" fill="#D4B896"/><text x="195" y="80" font-family="'Helvetica Neue',Arial,sans-serif" font-size="26" font-weight="800" fill="#1A1A1A" textLength="780" lengthAdjust="spacingAndGlyphs">[NOME]</text><rect x="195" y="95" width="60" height="3" rx="1.5" fill="#8B5E3C"/><text x="195" y="130" font-family="'Helvetica Neue',Arial,sans-serif" font-size="13" font-weight="600" fill="#8B5E3C" letter-spacing="3" textLength="500" lengthAdjust="spacingAndGlyphs">[SUBTÍTULO]</text></svg>`,
    "Logo Alternativo SVG": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 180" style="max-width:100%;width:100%;height:auto;display:block;aspect-ratio:6/1"><rect width="1080" height="180" fill="#1A1A1A" rx="12"/><circle cx="90" cy="90" r="50" fill="none" stroke="#8B5E3C" stroke-width="3"/><circle cx="90" cy="90" r="25" fill="#8B5E3C"/><text x="90" y="98" font-family="Georgia,serif" font-size="30" font-weight="bold" fill="#FFFFFF" text-anchor="middle">V</text><text x="170" y="80" font-family="'Helvetica Neue',Arial,sans-serif" font-size="26" font-weight="700" fill="#FFFFFF" textLength="800" lengthAdjust="spacingAndGlyphs">[NOME]</text><text x="170" y="115" font-family="'Helvetica Neue',Arial,sans-serif" font-size="12" font-weight="500" fill="#D4B896" letter-spacing="3">[SUBTÍTULO]</text></svg>`,
    "Cores da Marca": "Primria: #8B5E3C | Secundria: #6B4226 | Fundo Claro: #F5EFE8 | Texto: #1A1A1A | Detalhe: #D4B896",
    "Usos do Logo": "Versão Principal: fundo claro, uso geral. Versão Alternativa: fundo escuro, ideal para vídeos e stories.",
  }),
  capa: () => ({
    "Feed SVG": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 1350" style="max-width:100%;width:100%;height:auto;display:block;aspect-ratio:4/5"><defs><linearGradient id="bg" x1="0" y1="0" x2="1080" y2="1350" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#1A1A1A"/><stop offset="100%" stop-color="#2D2D2D"/></linearGradient></defs><rect width="1080" height="1350" fill="url(#bg)"/><circle cx="850" cy="200" r="250" fill="#8B5E3C" opacity="0.04"/><circle cx="200" cy="1100" r="200" fill="#8B5E3C" opacity="0.03"/><rect x="80" y="300" width="3" height="40" rx="1.5" fill="#D4B896"/><text x="100" y="318" font-family="'Helvetica Neue',Arial,sans-serif" font-size="11" font-weight="600" fill="#D4B896" letter-spacing="4">[TAG]</text><polygon points="540,380 548,396 540,392 532,396" fill="#D4B896" opacity="0.6"/><text x="540" y="460" font-family="'Helvetica Neue',Arial,sans-serif" font-size="34" font-weight="800" fill="#FFFFFF" text-anchor="middle">[HEADLINE]</text><text x="540" y="510" font-family="'Helvetica Neue',Arial,sans-serif" font-size="34" font-weight="800" fill="#D4B896" text-anchor="middle">[DESTAQUE]</text><line x1="440" y1="540" x2="640" y2="540" stroke="#8B5E3C" stroke-width="2" opacity="0.5"/><text x="540" y="585" font-family="Arial,sans-serif" font-size="15" font-weight="400" fill="#FFFFFF" opacity="0.5" text-anchor="middle">[SUBTÍTULO]</text><rect x="80" y="1140" width="920" height="90" rx="6" fill="#8B5E3C" opacity="0.08"/><text x="540" y="1180" font-family="'Helvetica Neue',Arial,sans-serif" font-size="14" font-weight="700" fill="#FFFFFF" text-anchor="middle" letter-spacing="2">[NOME DO PRODUTO]</text><text x="540" y="1205" font-family="Arial,sans-serif" font-size="12" fill="#D4B896" text-anchor="middle">[OFERTA]</text></svg>`,
    "Reels SVG": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 1920" style="max-width:100%;width:100%;height:auto;display:block;aspect-ratio:9/16"><defs><linearGradient id="bg2" x1="0" y1="0" x2="0" y2="1920" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#1A1A1A"/><stop offset="100%" stop-color="#2D2D2D"/></linearGradient></defs><rect width="1080" height="1920" fill="url(#bg2)"/><circle cx="900" cy="300" r="260" fill="#8B5E3C" opacity="0.04"/><circle cx="150" cy="1600" r="210" fill="#8B5E3C" opacity="0.03"/><rect x="80" y="700" width="3" height="40" rx="1.5" fill="#D4B896"/><text x="100" y="718" font-family="'Helvetica Neue',Arial,sans-serif" font-size="12" font-weight="600" fill="#D4B896" letter-spacing="4">[TAG]</text><polygon points="540,800 548,816 540,812 532,816" fill="#D4B896" opacity="0.6"/><text x="540" y="880" font-family="'Helvetica Neue',Arial,sans-serif" font-size="38" font-weight="800" fill="#FFFFFF" text-anchor="middle">[HEADLINE]</text><text x="540" y="935" font-family="'Helvetica Neue',Arial,sans-serif" font-size="38" font-weight="800" fill="#D4B896" text-anchor="middle">[DESTAQUE]</text><line x1="440" y1="965" x2="640" y2="965" stroke="#8B5E3C" stroke-width="2" opacity="0.5"/><text x="540" y="1015" font-family="Arial,sans-serif" font-size="17" font-weight="400" fill="#FFFFFF" opacity="0.5" text-anchor="middle">[SUBTÍTULO]</text><rect x="80" y="1700" width="920" height="90" rx="6" fill="#8B5E3C" opacity="0.08"/><text x="540" y="1740" font-family="'Helvetica Neue',Arial,sans-serif" font-size="15" font-weight="700" fill="#FFFFFF" text-anchor="middle" letter-spacing="2">[NOME DO PRODUTO]</text><text x="540" y="1765" font-family="Arial,sans-serif" font-size="13" fill="#D4B896" text-anchor="middle">[OFERTA]</text></svg>`,
    "Dicas de Uso": "Feed: 1080x1350 (4:5). Reels: 1080x1920 (9:16). Poste como imagem ou capa de video.",
  }),
  card_oferta: () => ({
    "Card Oferta SVG": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 1350" style="max-width:100%;width:100%;height:auto;display:block;aspect-ratio:4/5"><defs><linearGradient id="cbg" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#1A1A1A"/><stop offset="100%" stop-color="#0D0D0D"/></linearGradient><linearGradient id="cg" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#8B5E3C"/><stop offset="100%" stop-color="#5C3A1E"/></linearGradient></defs><rect width="1080" height="1350" fill="url(#cbg)"/><rect x="30" y="30" width="1020" height="1290" rx="24" fill="none" stroke="#8B5E3C" stroke-width="2" opacity="0.3"/><circle cx="540" cy="800" r="320" fill="#8B5E3C" opacity="0.04"/><text x="540" y="220" font-family="'Helvetica Neue',Arial,sans-serif" font-size="32" font-weight="700" fill="#D4B896" text-anchor="middle" letter-spacing="8">OFERTA ESPECIAL</text><rect x="440" y="250" width="200" height="2" fill="#D4B896" opacity="0.5"/><text x="540" y="420" font-family="'Helvetica Neue',Arial,sans-serif" font-size="26" font-weight="400" fill="#FFFFFF" opacity="0.5" text-anchor="middle" text-decoration="line-through">DE [VALOR CHEIO]</text><text x="540" y="540" font-family="'Helvetica Neue',Arial,sans-serif" font-size="110" font-weight="800" fill="#FFFFFF" text-anchor="middle">[VALOR]</text><text x="540" y="620" font-family="Arial,sans-serif" font-size="26" font-weight="400" fill="#D4B896" text-anchor="middle">ou [N]x de [PARCELA]</text><rect x="290" y="730" width="500" height="65" rx="32" fill="url(#cg)"/><text x="540" y="772" font-family="'Helvetica Neue',Arial,sans-serif" font-size="20" font-weight="700" fill="#FFFFFF" text-anchor="middle" letter-spacing="3">GARANTIR OFERTA</text><text x="540" y="900" font-family="Arial,sans-serif" font-size="16" fill="#FFFFFF" opacity="0.5" text-anchor="middle">Oferta por tempo limitado</text><text x="540" y="950" font-family="Arial,sans-serif" font-size="16" fill="#FFFFFF" opacity="0.5" text-anchor="middle">7 dias de garantia incondicional</text></svg>`,
    "Indicado para": "Instagram Stories, Facebook Ads, WhatsApp, E-mail Marketing",
    "Copy para Legenda": "A oferta especial do [NOME DO PRODUTO] chegou! De [VALOR CHEIO] por apenas [VALOR] à vista ou [N]x de [PARCELA]. Vagas limitadas   garanta a sua agora! Link na bio.",
  }),
  certificado: () => ({
